...
const ChatLayout = lazy(() => import('./components/layout/ChatLayout').then(module => ({ default: module.ChatLayout })));
            ...
            <div className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm transition-all">
              ...
              <div className="hidden md:block">
                <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3 group cursor-pointer hover:opacity-90 transition-opacity" onClick={() => setCurrentView('dashboard')}>
                    <img src="/orbit_logo.png" alt="Orbit" className="w-9 h-9 object-contain drop-shadow-md group-hover:rotate-12 transition-transform duration-500" />
                  ...
                  <nav className="flex gap-1">
                    {[
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium smooth-transition relative overflow-hidden group ${currentView === item.id
                          ? 'text-primary'
