...
export function UploadingPlaceholder({ progress, estimatedTime, statusText }: UploadingPlaceholderProps) {
    const footerText =
    ...
    return (
        <div className="w-64 max-w-full h-48 bg-gray-200 rounded-lg flex flex-col items-center justify-center relative overflow-hidden">
            <div className="absolute inset-0 bg-blue-500 transition-all duration-300" style={{ width: `${progress}%`, opacity: 0.1 }}></div>
            <svg
            ...
            <div className="text-gray-700 text-base font-semibold mb-1 relative z-10">{progress}%</div>
